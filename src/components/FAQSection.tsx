...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: 'Yes, the SENT token contract has been audited and verified on PinkSale. The contract address is 0x65f6cEdBB6e023e7A91df61c26364FAc0fA2dd64 on Polygon. You can verify this on PolygonScan.'
    },
    {
