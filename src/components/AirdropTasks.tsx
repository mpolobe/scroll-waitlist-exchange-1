  ...
  const [tasks, setTasks] = useState<Task[]>([
    {
      ...
      description: "Follow @AfricaRailways on Twitter",
      points: 20,
      icon: <Twitter className="h-5 w-5 text-blue-400" />,
      action: "Follow",
      link: "https://twitter.com/AfricaRailways",
      completed: false,
    },
    {
      id: "telegram_join",
      title: "Join Telegram",
      description: "Join the Africa Railways Telegram group",
      points: 20,
      icon: <Send className="h-5 w-5 text-blue-500" />,
      action: "Join",
      link: "https://t.me/AfricaRailways",
      completed: false,
    },
    {
      id: "retweet",
      ...
      action: "Retweet",
      link: "https://twitter.com/AfricaRailways/status/airdrop",
      completed: false,
    },
    {
      id: "referral",
